      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 font-[Inter,Montserrat,sans-serif] text-[#003D6B]">
        ...
        >
          ...
          <p className="mt-3 text-sm sm:text-base leading-relaxed text-[#003D6B]/80">
            Link yang kamu akses tidak ditemukan atau tidak valid.
          </p>

          <button
            type="button"
            onClick={() => navigate("/")}
            className="mt-7 cursor-pointer rounded-xl bg-[#F58220] px-6 py-3 text-base font-bold text-white shadow-[0_12px_26px_rgba(245,130,32,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_32px_rgba(245,130,32,0.42)]"
          >
            Kembali ke Beranda
          </button>
        </motion.div>
...
export default SessionInvalidPage;